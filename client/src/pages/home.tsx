      ...
      <div className="pt-20 relative">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-8 text-center">
              <p>
              ...
              <p>
                В моём гардеробе постоянно были вещи, созданные мной: сумки, аксессуары, переделанные старые вещи.<br/>
