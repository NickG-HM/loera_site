...
export const baseProducts = [
  ...
  {
    CatalogueName: "Комплект Nuá Black Satin",
    ProductName: "Комплект Nuá Black Satin",
    description: "Nuá  — роскошный комплект из шелковистого атласа. Та самая классика, которая всегда будет актуальна. Бра с эффектом пуш-ап, без использования поролоновых подушечек.\n\nТрусики формы галочка обеспечат комфорт и красиво подчеркнут форму ягодиц.\n\nСостав: 80% полиэстер, 20% эластин \nЛастовица трусиков 100% хлопок\n\nРазмеры от 70 АА до 85 D\n\nПосле оформления заказа мы поможем вам подобрать размер. \n\n\nДоставка по Беларуси до пунктов Белпочта, Европочта.\n\nСтоимость доставки в РФ от 450 до 600 рублей. Точная стоимость зависит от адреса получателя.\n\nТакже есть международная доставка в большинство стран. Стоимость рассчитывается индивидуально",
    priceBYN: "170",
    priceRUB: "4600",
    image: "nua-black-satin_main.jpg",
    category: "нижнее белье",
    gallery: ["nua-black-satin_2.jpg", "nua-black-satin_3.jpg", "nua-black-satin_4.jpg", "nua-black-satin_5.jpg", "nua-black-satin_6.jpg", "nua-black-satin_7.jpg", "nua-black-satin_8.jpg", "nua-black-satin_9.jpg", "nua-black-satin_10.jpg"]
  },
  {
    CatalogueName: "Комплект Nuá Milk Satin",
    ProductName: "Комплект Nuá Milk Satin",
    description: "Nuá  — роскошный комплект из шелковистого атласа. Та самая классика, которая всегда будет актуальна. Бра с эффектом пуш-ап, без использования поролоновых подушечек.\n\nТрусики формы галочка обеспечат комфорт и красиво подчеркнут форму ягодиц.\n\nСостав: 80% полиэстер, 20% эластин \nЛастовица трусиков 100% хлопок\n\nРазмеры от 70 АА до 85 D\n\nПосле оформления заказа мы поможем вам подобрать размер.\n\n\nДоставка по Беларуси до пунктов Белпочта, Европочта.\n\nСтоимость доставки в РФ от 450 до 600 рублей. Точная стоимость зависит от адреса получателя.\n\nТакже есть международная доставка в большинство стран. Стоимость рассчитывается индивидуально",
    priceBYN: "170",
    priceRUB: "4600",
    image: "nua-milk-satin_3.jpg",
    category: "нижнее белье",
    gallery: ["nua-milk-satin_2.jpg", "nua-milk-satin_main.jpg", "nua-milk-satin_4.jpg", "nua-milk-satin_5.jpg", "nua-milk-satin_6.jpg", "nua-milk-satin_7.jpg", "nua-milk-satin_8.jpg", "nua-milk-satin_9.jpg"]
  },
  {
    CatalogueName: "Трусики Nuá Black Satin",
    ProductName: "Трусики Nuá Black Satin",
    description: "Трусики формы галочка обеспечат комфорт и красиво подчеркнут форму ягодиц.\n\nСостав: 80% полиэстер, 20% эластин \nЛастовица трусиков 100% хлопок\n\n\nПосле оформления заказа мы поможем вам подобрать размер.\n\n\nДоставка по Беларуси до пунктов Белпочта, Европочта.\n\nСтоимость доставки в РФ от 450 до 600 рублей. Точная стоимость зависит от адреса получателя.\n\nТакже есть международная доставка в большинство стран. Стоимость рассчитывается индивидуально",
    priceBYN: "60",
    priceRUB: "1600",
    image: "trusiki-black-satin_2.jpg",
    category: "нижнее белье",
    gallery: ["trusiki-black-satin_main.jpg", "trusiki-black-satin_3.jpg", "trusiki-black-satin_4.jpg"]
  },
  {
    CatalogueName: "Трусики Nuá Milk Satin",
    ProductName: "Трусики Nuá Milk Satin",
    description: "Трусики формы галочка обеспечат комфорт и красиво подчеркнут форму ягодиц.\n\nСостав: 80% полиэстер, 20% эластин \nЛастовица трусиков 100% хлопок\n\n\nПосле оформления заказа мы поможем вам подобрать размер.\n\n\nДоставка по Беларуси до пунктов Белпочта, Европочта.\n\nСтоимость доставки в РФ от 450 до 600 рублей. Точная стоимость зависит от адреса получателя.\n\nТакже есть международная доставка в большинство стран. Стоимость рассчитывается индивидуально",
    priceBYN: "60",
    priceRUB: "1600",
    image: "trusiki-milk-satin_main.jpg",
    category: "нижнее белье",
    gallery: ["trusiki-milk-satin_2.jpg", "trusiki-milk-satin_3.jpg"]
  }
];
