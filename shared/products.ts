...
export const baseProducts = [
  {
    ...
    description: "Мягкая синтепоновая сумка подходит для любого сезона. Длину ручки можно легко регулировать — завяжите бант или узел на свой вкус.\nСумка закрывается на молнию.\nмы используем только качественную фурнитуру)\n\nРазмеры:\nШирина 44\nВысота 28\nДлина одной ручки 88см\n\nМатериал: хлопок, синтепон.\n\nБесплатная доставка по Беларуси до пунктов Белпочта, Европочта.\n\nСтоимость доставки в РФ от 450 до 600 рублей. Точная стоимость зависит от адреса получателя.\n\nТакже есть международная доставка в большинство стран. Стоимость рассчитывается индивидуально",
    priceBYN: "280",
    priceRUB: "7700",
    image: "bow-bag-kletka_main.jpg",
    category: "bags",
    gallery: []
  },
  {
    CatalogueName: "New Bag 2",
    ProductName: "New Bag 2",
    description: "TODO: Add description here\n\nБесплатная доставка по Беларуси до пунктов Белпочта, Европочта.\n\nСтоимость доставки в РФ от 450 до 600 рублей. Точная стоимость зависит от адреса получателя.\n\nТакже есть международная доставка в большинство стран. Стоимость рассчитывается индивидуально",
    priceBYN: "0",
    priceRUB: "0",
    image: "new_bag_2_main.jpg",
    category: "bags",
    gallery: []
  },
  {
    CatalogueName: "New Bag 3",
    ProductName: "New Bag 3",
    description: "TODO: Add description here\n\nБесплатная доставка по Беларуси до пунктов Белпочта, Европочта.\n\nСтоимость доставки в РФ от 450 до 600 рублей. Точная стоимость зависит от адреса получателя.\n\nТакже есть международная доставка в большинство стран. Стоимость рассчитывается индивидуально",
    priceBYN: "0",
    priceRUB: "0",
    image: "new_bag_3_main.jpg",
    category: "bags",
    gallery: []
  },
  {
    CatalogueName: "New Bag 4",
    ProductName: "New Bag 4",
    description: "TODO: Add description here\n\nБесплатная доставка по Беларуси до пунктов Белпочта, Европочта.\n\nСтоимость доставки в РФ от 450 до 600 рублей. Точная стоимость зависит от адреса получателя.\n\nТакже есть международная доставка в большинство стран. Стоимость рассчитывается индивидуально",
    priceBYN: "0",
    priceRUB: "0",
    image: "new_bag_4_main.jpg",
    category: "bags",
    gallery: []
  },
  {
